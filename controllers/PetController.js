...
module.exports = class PetController {
    ...
    static async removePetById(req, res){
        ...
        if(pet.user._id.toString() !== user._id.toString()){
            res.status(422).json({ message: "Houve um problema em processar sua solicitacao, tente novamente mais tarde" })
            return
        }
    ...
    static async concludeAdoption(req, res){
        ...
        res.status(200).json({ message: "Parabens! O ciclo de adocao foi finalizado com sucesso" })
